...
\texttt{SpikeCorrected} y \texttt{ChannelStats}. En las secciones finales de este capitulo hablaremos sobre estos módulos funcionales. 
...
Ext.define('MyApp.controller.Users', {
   ...
   onLaunch: function() {
	...
	\subsection{\texttt{Navigation}}
		...
		soporta tres valores diferentes como \emph{hash} que son \texttt{[Spike, SpikeCorrected, ChannelStats]}. Estos tres valores
