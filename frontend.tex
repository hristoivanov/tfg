...
\section{Descripción funcional}
	...
	\subsection{\texttt{Spike}}
		...
		\par
		Cuando no es necesario agrupar los datos el botón \texttt{CandleChart} es habilitado.  Este botón muestra un gráfico segundario con
		...
		gráfico nos permite observar el comportamiento de los diferentes tubos.
	\subsection{\texttt{SpikeRevised}}
		...
		descrita. En el gráfico será añadida un \emph{flag}, la letra que aparece en dicho \emph{flag} se corresponde con el campo
