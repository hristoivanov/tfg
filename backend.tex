...
un procedimiento no es influenciada por eventos anteriores, esta tan sólo depende de los parámetros proporcionados.
\par
...
\section{Servicios RPC}
	...
	\subsection{\texttt{nmdbOriginalGroup}}
		...
		el valor global, la corrección por presión y la corrección por eficiencia. Para la presión atmosférica tan sólo es calculado el valor
	...
	\subsection{\texttt{nmdadbChannelHistogram}}
		...
		Seguidamente podemos ver la query utilizada para construir el histograma devuelto por este servicio.
			...
			\end{center} 
		La query calcula el histograma para un único canal, especificado por la variable \texttt{\$channel}. Para construir el histograma de
		...
		la que las demás queries son efectivas. En esta query tenemos que agrupar por el número de cuentas, campo que no está indexado. Por
