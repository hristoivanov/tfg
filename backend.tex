...
\section{Servicios RPC}
	...
	\subsection{\texttt{nmdadbChannelHistogram}}
		...
		los 18 canales esta query es invocada múltiples veces. En esta query tenemos que agrupar por el número de cuentas, campo que no está
		indexado. Esto hace que la consulta tarde bastante más tiempo que las otras, por lo tanto no es recomendable invocarla con mucha
