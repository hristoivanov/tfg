...
% configuración del paquete hyperref
\hypersetup{    pdfauthor = {Rajesh Ramayan Koothrappali}
               pdftitle = {The Dumpling Paradox of the The Maternal Capacitance
               and its Robotic Manipulation.},
               pdfkeywords = {MVC, Via-Plata, Fichas,TFC},
...
\rhead[
        \fancyplain{}
        {\textrm{\footnotesize\ Rajesh Ramayan Koothrappali}}]
        {\fancyplain{}
...
%\include{ambitoyobjetivos}
%\include{analisisderequisitos}
%\include{diseno}
