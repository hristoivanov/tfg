...
El propósito de este documento es describir el \emph{Trabajo fin de Grado} realizado por el autor. Este es parte del desarrollo de un nuevo sistema de
...
\par
Empezamos este capítulo haciendo una breve introducción a los conceptos teóricos y el entrono en el que se desarrolla este trabajo. Continuamos
estableciendo los objetivos y el diseño preliminar. Finalmente son aclaradas algunas peculiaridades referentes al proceso de adquisición de datos. El
segundo capítulo describe el entorno hardware en el que es desarrollado el software de adquisición. Los siguientes capítulos describen en detalle el
...
\section{Introducción a los rayos cósmicos}
	...
	tan sólo tienen una pequeña fracción de la energía inicial. Si una partícula no posee la energía suficiente la cascada que es originada no se
