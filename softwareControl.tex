...
\section{Arranque automático del sistema}
	...
	por defecto está configurada para arrancar automáticamente, debemos configurarla para que inicialice nuestro software. Para este propósito
...
Pin P8_10(GPIO_68)   --> Señal STROBE del barómetro AP1.
	...
	\subsection{Resetear FPGA}
		...
		empezar con la adquisición de datos. Este Reset nos asegura que la FPGA está en un correcto estado. Para realizar el Reset de la FPGA
