...
\chapter{Despliegue aplicación Web. \emph{Back-end}}
	\label{app_back}
...
http://localhost:8080/nmCpanel/index.html
	\end{lstlisting}
	Eventualmente para que todo funcione bien deberemos verificar quela configuración referente a las bases de datos que creamos anteriormente es
	correcta. Para este propósito debemos examinar los archivos \texttt{config/autoload/global.php} y {config/autoload/local.php}.

\chapter{Despliegue aplicación Web. \emph{Front-end}}
	\label{app_front}
